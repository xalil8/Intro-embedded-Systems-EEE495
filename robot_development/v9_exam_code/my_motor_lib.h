...
*                      CONSTANTS
*************************************************************/
#define step_number 256  //512 approximately 1 revolution, 2*512= 2 revolution
#define motor_speed 2100//his calculated based on main clock work, lower is faster
#define divider 2
